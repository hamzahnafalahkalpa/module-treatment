...
namespace Gilanggustina\ModuleTreatment\Facades;
...
*/
class ModuleTreatment extends \Illuminate\Support\Facades\Facade
{
    /**
    ...
    {
        return \Gilanggustina\ModuleTreatment\Contracts\ModuleTreatment::class;
    }
}